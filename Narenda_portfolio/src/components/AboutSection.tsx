          ...
          >
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[15px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5">
                  Patents in Process
                </span>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[18px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5">
                   of 2026-27.
                </span>
              </div>
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                ...
                <img
                  src={aboutImg}
                  alt="Kurapati Narendra Nath Reddy"
