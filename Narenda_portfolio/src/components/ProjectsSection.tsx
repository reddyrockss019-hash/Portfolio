...
const projects: Project[] = [
  {
    number: '01',
    title: 'AI-EV-Charger',
    category: 'AI / It is Ai Based EV Charging Infrastructure',
    description:
      'AI-powered platform engineered for automated EV charging infrastructure management across web, desktop, and mobile. real-time Tracking, and Time Management intelligence.',
    githubUrl: 'https://github.com/reddyrockss019-hash/AI-EV-Charger',
    tech: [
      'TypeScript',
      'CSS',
      'React Native',
  ...
  },
  {
    ...
    number: '02',
    title: 'Web-Saathii',
    category: 'Website generation in Regional languages PLATFORM.',
    description:
      'WebSaathii introduces a guided AI-based website builder that simplifies the entire process for non-technical users. Instead of directly generating a website, it interacts with users step-by-step, suggests relevant business services based on their type, and allows content generation in regional languages.',
    githubUrl: 'https://github.com/reddyrockss019-hash/Web-Saathii',
    tech: [
      'React.js',
      'TypeScript',
      'Python',
    ...
    metrics: [
      { label: 'MODEL', value: 'First Digital Foot Print' },
      { label: 'ACCURACY', value: 'High Precision' },
      { label: 'DASHBOARD', value: 'Live Regional Insights' },
    ],
  },
  {
    number: '03',
    title: 'Tejomaya-Foods',
    category: 'CLOUD / ERP Ecommerce SYSTEM',
    description:
      'Tejomaya Foods is a Hyderabad-based FMCG and cloud kitchen startup specializing in traditional, preservative-free Indian foods. They focus on fresh, convenient meal solutions, daily staples, and heritage snacks.',
    githubUrl: 'https://github.com/reddyrockss019-hash/Tejomaya-Foods',
    tech: [
      'Node.js',
      'Express.js',
      'PostgreSQL',
