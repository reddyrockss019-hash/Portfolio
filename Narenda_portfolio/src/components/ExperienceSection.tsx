...
const journey: RouteStop[] = [
  {
    ...
    organization: 'TEJOMAYA FOODS',
    description: 'ERP Ecommerce cross-platform mobile and responsive web applications utilizing React Native and modern full-stack workflows.',
  },
  {
    id: '02',
    year: 'OCT - DEC 2025',
    title: 'AI-EV-Charging HACKATHON WINNER',
    organization: 'EV HACKATHON LPU',
    description: 'AI-powered platform engineered for automated EV charging infrastructure management across web, desktop, and mobile. Real-time tracking and Time Management intelligence .',
  },
  {
    id: '03',
    year: 'MAY - JUN 2025',
    title: 'Web Saathii',
    organization: 'LPU EDU-REV HACKTHON',
    description: 'WebSaathii introduces a guided AI-based website builder that simplifies the entire process for non-technical users, developing and deploying end-to-end interactive responsive web platforms.',
  },
  {
    id: '04',
    year: '2025 MILESTONE',
    title: 'Winner of Start-up Sprint LPU',
    organization: 'Department of Startups LPU',
    description: 'Winner of 2025 Start-up Sprint LPU, recognized for innovative solutions in the startup ecosystem.',
  },
];
